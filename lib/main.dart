...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    _restrooms = [
      ...
      Restroom(
        imageColor: const Color(0xFF1976D2),
        imagePath: 'assets/images/marquee-mall.webp',
        name: 'Marquee Mall CR',
        address: 'Angeles Magalang Road, Angeles City',
        latitude: 15.1626197,
        longitude: 120.6098906,
      ...
      Restroom(
        imageColor: const Color(0xFF42A5F5),
        imagePath: 'assets/images/nepo-mall.webp',
        name: 'Nepo Mall Angeles',
        address: 'Nepo Complex, McArthur Highway, Angeles City',
        latitude: 15.1349646,
        longitude: 120.5884236,
        distance: '500 m away',
        rating: 4.0,
        reviewCount: 23,
        amenities: ['Soap', 'Tissue', 'Lock'],
        cardColor: const Color(0xFFE3F2FD),
        isOpen: true,
        openingTime: const TimeOfDay(hour: 10, minute: 0),
      ...
      Restroom(
        imageColor: const Color(0xFF1976D2),
        imagePath: 'assets/images/clark-museum.webp',
        name: 'Clark Museum and 4D Theater',
        address: 'Bldg 5655, Clark Freeport Zone',
        latitude: 15.182244,
        longitude: 120.5242601,
        distance: '6.8 km away',
        rating: 4.0,
        reviewCount: 58,
        amenities: ['Soap', 'Tissue', 'Lock', 'Clean'],
        cardColor: const Color(0xFFE3F2FD),
        isOpen: true,
      ...
      Restroom(
        imageColor: const Color(0xFF42A5F5),
        imagePath: 'assets/images/fontana-leisure.webp',
        name: 'Fontana Leisure Parks',
        address: 'Clark Freeport Zone, Pampanga',
        latitude: 15.1933329,
        longitude: 120.506968,
        distance: '4.5 km away',
        rating: 4.3,
        reviewCount: 55,
        amenities: ['Bidet', 'Soap', 'Tissue', 'Lock', 'Accessible'],
        cardColor: const Color(0xFFE3F2FD),
        isOpen: false,
        openingTime: const TimeOfDay(hour: 8, minute: 0),
